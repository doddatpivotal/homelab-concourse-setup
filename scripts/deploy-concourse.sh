...
bosh -e bosh-concourse -d concourse -n \
  ...
  -o local-cache/concourse-bosh-deployment/cluster/operations/credhub-colocated.yml \
  ...
  -o local-cache/concourse-bosh-deployment/cluster/operations/backup-atc-colocated-web.yml \
